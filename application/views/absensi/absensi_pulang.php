          ...
          <center>
            <?php if(empty($absensi_terakhir)): ?>
             ...
             <form id="myForm" action="" method="POST">
              <input type="text" name="rfid" autofocus="" class="form-control border border-2 border-success" placeholder="Masukan ID anda" oninput="handleRFIDScan(event)">
            </form>
           <!--  <br>
          ...
          <table class="table border table-stripped "><!-- 
            ...
            <tbody>
              ...
              $absen = $this->db->query("SELECT * FROM tb_absen as a
               ...
               <?php if(empty($absen)) : ?>
                <tr>
                  <th colspan="6"><center>No data available in table</center></th>
                </tr>
              <?php endif; ?>
              ...
              <?php  foreach ($absen as $key => $data):?>
                ...
                <tr>
                  ...
                  <td style="font-weight: bold;"><?php echo $data['jam_pulang']; ?></td>
                  <td style="background-color: <?php echo ($data['keterangan_pulang']=='Pulang Cepat') ? '#ff7675': '#1dd1a1'; ?>; color: white;">
