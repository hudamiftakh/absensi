        ...
        <div class="card-body2">
          <center>
            <?php if(empty($absensi_terakhir)): ?>
              <img src="<?php echo base_url(); ?>assets/siswa/blank.jpg" class="rounded-circle  border border-danger border-5" style="width: 200px; height: 200px" >
              <?php else : ?>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="d-flex align-items-center mb-7">
                    <h5 class="fw-semibold mb-0 fs-5">Absen Masuk <?php echo farmat_tanggal(date('Y-m-d')); ?> </h5>
                  </div>
      ...
      <table class="table table-border table-stripped ">
        ...
        <tbody>
          ...
          $absen = $this->db->query("SELECT * FROM tb_absen as a
           LEFT JOIN tb_siswa as b ON a.id_siswa = b.id
           WHERE a.tanggal ='".date('Y-m-d')."' ORDER BY a.jam_masuk DESC LIMIT 20")->result_array();
           ?>
           <?php if(empty($absen)) : ?>
            <tr>
