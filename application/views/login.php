...
<html lang="en">
<head>
  <title>E-Absensi MIN Jombang</title>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/png" href="<?php echo base_url(); ?>assets/logo_min.png" />
  <!-- Owl Carousel -->
        ...
        <div class="row">
          <div class="col-xl-7 col-xxl-8">
            ...
            <div class="d-none d-xl-flex align-items-center justify-content-center" style="height: calc(100vh - 80px);">
              <img src="<?php echo $base_url; ?>dist/images/backgrounds/login-security.svg" alt="" class="img-fluid" width="500">
            </div>
          </div>
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
              <div class="col-sm-8 col-md-6 col-xl-9">
               <center> <img src="<?php echo base_url(); ?>assets/logo_min.png" height="120px">
                <br>
                <br>
                <h2 class="mb-3 fs-7 fw-bolder" style="font-weight: bold;">ALMAS</h2>
                <h2 class="mb-3 fs-7 fw-bolder" style="font-weight: bold;">Aplikasi <label style="font-weight: bold; color: #27ae60">#Digital</label> Madrasah</h2>
                <p class="mb-9">MIN 1 Jombang</p>
              </center>
              <div class="row">
